...
const BoardPage = () => {
  ...
  useEffect(() => {
    const filteredColumns = columnsAPI.filter(
      (column) => column.board_id === selectedBoard
    );
  ...
  const moveTaskLeft = async (taskId, currentColumnId) => {
    ...
    const currentColumnIndex = columns.findIndex(
      (column) => column.column_id === currentColumnId
    );
                      ...
                      >
                        <div className="color-picker">
                          <div
                            ...
                            onClick={() =>
                              handleChangeColor(column.column_id, '#DE5959')
                            }
                            style={{ backgroundColor: '#DE5959' }}
                          ></div>
                          <div
                            className="color-option"
                            onClick={() =>
                              handleChangeColor(column.column_id, '#E8D677')
                            }
                            style={{ backgroundColor: '#E8D677' }}
                          ></div>
                          <div
                            className="color-option"
                            onClick={() =>
                              handleChangeColor(column.column_id, '#F2994A')
                            }
                          ...
                          <div
                            className="color-option"
                            onClick={() =>
                              handleChangeColor(column.column_id, '#8AE38E')
                            }
                            style={{ backgroundColor: '#8AE38E' }}
                          ></div>
                          <div
                            className="color-option"
                            onClick={() =>
                              handleChangeColor(column.column_id, '#5987DE')
                            }
                            style={{ backgroundColor: '#5987DE' }}
                          ></div>
                          <div
                            className="color-option"
                            onClick={() =>
                              handleChangeColor(column.column_id, '#8C59DE')
                            }
                            style={{ backgroundColor: '#8C59DE' }}
                          ></div>
                        </div>
                        <button
                  ...
                  <PopoverContent sideOffset={10}>
                    <div className="popover-content">
                      ...
                      <button
                        ...
                        onClick={() =>
                          handleAddTask(column.column_id, newTaskDescription)
                        }
                      >
                        Подтвердить
                      </button>
                        ...
                        <PopoverContent sideOffset={10} side="right">
                          ...
                          >
                            <div className="task-move-container">
                              <button
                                onClick={() =>
                                  moveTaskLeft(task.task_id, column.column_id)
                                }
                              ...
                              <button
                                onClick={() =>
                                  moveTaskRight(task.task_id, column.column_id)
                                }
                                className="task-move-button"
                              >
                                <img
